...
func (c *client) RemoveHostnameFromDeployment(ctx context.Context, hostname string, leaseID ctypes.LeaseID, allowMissing bool) error {
...
func (lh leaseIDHostnameConnection) GetLeaseID() ctypes.LeaseID {
	return lh.leaseID
}
