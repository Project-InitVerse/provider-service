...
func (c *client) LeaseStatus(ctx context.Context, id v1.LeaseID) (LeaseStatus, error) {
...
func (c *client) LeaseEvents(ctx context.Context, id v1.LeaseID, _ string, follow bool) (*LeaseKubeEvents, error) {
...
func (c *client) ServiceStatus(ctx context.Context, id v1.LeaseID, service string) (*cltypes.ServiceStatus, error) {
