...
import (
	...
	akashnetworkv2beta1 "providerService/src/pkg/apis/akash.network/v2beta1"
	...
	v2beta1 "providerService/src/pkg/client/listers/akash.network/v2beta1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AkashV2beta1().ProviderHosts(namespace).List(context.TODO(), options)
			},
