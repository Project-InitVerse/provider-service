...
import (
	v1 "providerService/src/pkg/client/informers/externalversions/akash.network/v1"
	v2beta1 "providerService/src/pkg/client/informers/externalversions/akash.network/v2beta1"
