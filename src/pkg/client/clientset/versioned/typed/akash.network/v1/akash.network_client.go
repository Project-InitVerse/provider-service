...
import (
	...
	"providerService/src/pkg/client/clientset/versioned/scheme"
)
...
// NewForConfigAndClient creates a new AkashV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AkashV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &AkashV1Client{client}, nil
}

// NewForConfigOrDie creates a new AkashV1Client for the given config and
...
func New(c rest.Interface) *AkashV1Client {
	return &AkashV1Client{c}
}
