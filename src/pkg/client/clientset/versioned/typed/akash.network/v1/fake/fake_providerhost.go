...
var providerhostsResource = schema.GroupVersionResource{Group: "akash.network", Version: "v1", Resource: "providerhosts"}

var providerhostsKind = schema.GroupVersionKind{Group: "akash.network", Version: "v1", Kind: "ProviderHost"}
...
func (c *FakeProviderHosts) Get(ctx context.Context, name string, options v1.GetOptions) (result *akashnetworkv1.ProviderHost, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(providerhostsResource, c.ns, name), &akashnetworkv1.ProviderHost{})

	if obj == nil {
		return nil, err
	}
	return obj.(*akashnetworkv1.ProviderHost), err
}

// List takes label and field selectors, and returns the list of ProviderHosts that match those selectors.
func (c *FakeProviderHosts) List(ctx context.Context, opts v1.ListOptions) (result *akashnetworkv1.ProviderHostList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(providerhostsResource, providerhostsKind, c.ns, opts), &akashnetworkv1.ProviderHostList{})
	...
	list := &akashnetworkv1.ProviderHostList{ListMeta: obj.(*akashnetworkv1.ProviderHostList).ListMeta}
	for _, item := range obj.(*akashnetworkv1.ProviderHostList).Items {
...
func (c *FakeProviderHosts) Create(ctx context.Context, providerHost *akashnetworkv1.ProviderHost, opts v1.CreateOptions) (result *akashnetworkv1.ProviderHost, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(providerhostsResource, c.ns, providerHost), &akashnetworkv1.ProviderHost{})
...
func (c *FakeProviderHosts) Update(ctx context.Context, providerHost *akashnetworkv1.ProviderHost, opts v1.UpdateOptions) (result *akashnetworkv1.ProviderHost, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(providerhostsResource, c.ns, providerHost), &akashnetworkv1.ProviderHost{})
...
func (c *FakeProviderHosts) UpdateStatus(ctx context.Context, providerHost *akashnetworkv1.ProviderHost, opts v1.UpdateOptions) (*akashnetworkv1.ProviderHost, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(providerhostsResource, "status", c.ns, providerHost), &akashnetworkv1.ProviderHost{})
...
func (c *FakeProviderHosts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(providerhostsResource, c.ns, name, opts), &akashnetworkv1.ProviderHost{})
...
func (c *FakeProviderHosts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *akashnetworkv1.ProviderHost, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(providerhostsResource, c.ns, name, pt, data, subresources...), &akashnetworkv1.ProviderHost{})
