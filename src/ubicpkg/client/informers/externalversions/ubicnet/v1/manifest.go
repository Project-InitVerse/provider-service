	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.UbicnetV1().Manifests(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UbicnetV1().Manifests(namespace).Watch(context.TODO(), options)
			},
		},
		&ubicnetv1.Manifest{},
		resyncPeriod,
...
func (f *manifestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ubicnetv1.Manifest{}, f.defaultInformer)
}
